...
def create_str_token_mapping(df):
    ...
    dill.dump(obj={'diag_voc': diag_voc, 'med_voc': med_voc,
                   'pro_voc': pro_voc}, file=open('output_iii/voc_final.pkl', 'wb'))
...
def create_patient_record(df, diag_voc, med_voc, pro_voc):
    ...
    dill.dump(obj=records, file=open('output_iii/records_final.pkl', 'wb'))
    return records
...
def get_ddi_matrix(records, med_voc, ddi_file):
    ...
    dill.dump(ehr_adj, open('output_iii/ehr_adj_final.pkl', 'wb'))
    ...
    dill.dump(ddi_adj, open('output_iii/ddi_A_final.pkl', 'wb'))
